...
## Environments
- Preview: https://main--gabrielwalt-medtronic--aemysites.aem.page/
- Live: https://main--gabrielwalt-medtronic--aemysites.aem.live/
- Block Library: https://main--gabrielwalt-medtronic--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `gabrielwalt-medtronic` directory in your favorite IDE and start coding :)
